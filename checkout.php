...
if(isset($_POST['submit'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if($address == ''){
         $message[] = 'Por favor adicione algum endereço!';
      }else{
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p class="grand-total"><span class="name">Total Geral :</span><span class="price">$<?= $grand_total; ?></span></p>
   ...
   <div class="user-info">
         ...
         <span>
            <?php 
               if($fetch_profile['address'] == '')
                  {echo 'Por favor digite seu endereço';}
               else
      ...
      <input type="submit" value="Finalizar" class="btn <?php if($fetch_profile['address'] == ''){echo 'Desativado';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
