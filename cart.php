...
if(isset($_POST['delete'])){
   ...
   $message[] = 'Item do carrinho excluído!';
}
...
<div class="heading">
   ...
   <p><a href="home.php">Home</a> <span> / Carrinho</span></p>
</div>
...
<section class="products">
   ...
   <div class="cart-total">
      <p>Total do carrinho : <span>$<?= $grand_total; ?></span></p>
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Fazer o check-out</a>
   </div>
