...
<div class="heading">
   ...
   <p><a href="home.php">Home</a> <span> / Contato</span></p>
</div>
...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <input type="email" name="email" maxlength="50" class="box" placeholder="Digite seu email" required>
         <textarea name="msg" class="box" required placeholder="Sua mensagem" maxlength="500" cols="30" rows="10"></textarea>
