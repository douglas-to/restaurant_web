...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="new_pass" maxlength="20" placeholder="Digite sua senha nova" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="confirm_pass" maxlength="20" placeholder="Confirme sua senha nova" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
