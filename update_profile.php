...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="Sua antiga senha" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="Sua nova senha" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
