...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Seu endereço</h3>
      <input type="text" class="box" placeholder="Endereço" required maxlength="50" name="flat">
      <input type="text" class="box" placeholder="Casa" required maxlength="50" name="building">
      ...
      <input type="number" class="box" placeholder="CEP" required max="99999999" min="0" maxlength="8" name="pin_code">
